        ...
        <div class="row">
            <div class="col-xl-4">
                <div class="page-title-box">
                    <h4 class="title-default display-inline mr-15">Add New Project</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-lg-9 col-xl-9">
                <div class="card">
                    <div class="card-body">
                        <div class="mb-3">
                            <label for="youtube_url">Project Name</label>
                            <input value="{{old('name',$project->name)}}" class="form-control" type="text" placeholder="Project title" name="name">
                        </div>
                        <div class="mb-3">
                            <label for="org">Organization</label>
                            <select name="org_id" id="org" class="form-control mb-3" aria-label="Large select example">
                                <option selected value="{{$project->org_id}}">{{$project->org->org_name}}</option>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="elm1"  class="form-control" rows="3" name="project_details">{{old('project_details',$project->project_details)}}</textarea>
                        </div>
                    </div>
                </div>
            </div>
