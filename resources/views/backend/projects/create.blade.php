                ...
                <div class="card">
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input value="{{old('name')}}" class="form-control" type="text" placeholder="Project title" name="name">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="elm1"  class="form-control" rows="3" name="project_details">{{old('project_details')}}</textarea>
                        </div>
                    </div>
                </div>
            </div>
