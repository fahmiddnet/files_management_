            ...
            <div class="col-lg-12 col-xl-12">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            <div>
                                ...
                                <input value="{{old('org_name')}}" id="org_name" class="form-control" type="text" placeholder="Organization name" name="org_name">
                                @error('org_name')
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{ old('org_phone')}}" name="org_phone" class="form-control" type="text"  id="phone_number" placeholder="Phone number">
                            @error('org_phone')
                                    <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div class="card">
                    <div class="card-body">
                            ...
                            <div id="accordion" class="custom-accordion">
                                <div class="card">
                                    ...
                                    <div id="org_address" class="collapse"
                                        ...
                                        <div class="card-body">
                                            <textarea id="elm2" name="org_address">{{old('org_address')}}</textarea>
                                    ...
                                    <div id="org_details" class="collapse"
                                        ...
                                        <div class="card-body">
                                            <div class="texteditor">
                                                ...
                                                <textarea id="elm1" name="org_info">{{old('org_info')}}</textarea>
                                            </div>  
                                        </div>
                                    </div>
                                </div>
                        ...
                        <!-- end: photo gallery -->
                        <div class="card-foot">
                            <button type="submit" class="btn btn-md btn-primary btn-primary waves-effect waves-light">Save</button>
