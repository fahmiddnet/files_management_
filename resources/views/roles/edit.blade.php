                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{ old('name',$role->name)}}" name="name" class="form-control" type="text"  id="role-name">
                            @error('name')
                        ...
                        <div class="mb-3">
                            @if($permissions->isNotEmpty())
                                @foreach ($permissions as $permission)
                                    <input {{ ($hasPermissions->contains($permission->name)) ? 'checked' : '' }} type="checkbox" name="permission[]" class="rounded" id="{{ $permission->id }}"
